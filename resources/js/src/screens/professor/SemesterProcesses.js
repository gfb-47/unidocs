...
function createData(StudentName, StudentEmail, title, professorName, professorEmail, semester, status, StudentColor, ProfessorColor) {
  return { StudentName, StudentEmail, title, professorName, professorEmail, semester, status, StudentColor, ProfessorColor };
}

//Preencha a função createData() com o mesmo numero de variaveis que voce colocou acima.
const rows = [
  createData('AlunoNome', 'AlunoEmail', 'Titulo do Projeto', 'ProfessorNome', 'ProfessorEmail', '2021.1/TCC', 'Em Desenvolvimento', '#0E4DA4', '#9B51E0'),
];
//----FIM DA Sessão 1----
